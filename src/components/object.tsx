...
export const ingles = {
    ...
    about: `Hello, my name is Johan Berrio and I am a <strong>full-stack </strong>software developer with over five years of experience.
            ...
            <br></br>
            As a professional, I stand out for being responsible and committed to each project. I strive to deliver on time and in the correct manner,
            managing each task efficiently. In addition, programming is my passion, so I develop both personal and work projects.`,
    job: "Full Stack Developer",
    span_english: "English",
    span_spanish: "Spanish",
    portfolio: "Portfolio",
    phrases : [
...
export const español = {
    ...
    about: `Hola, mi nombre es Johan Berrio y soy desarrollador de software <strong>full stack</strong> con más de cinco años de experiencia. 
                ...
                <strong>GitHub, GitLab, Jenkins y Docker</strong>. En cuanto a bases de datos, he trabajado ampliamente con motores como <strong>SQL Server, MySQL, PostgreSQL, MongoDB y SQLite</strong>.
                <br></br>
                Como profesional, me destaco por ser responsable y comprometido con cada proyecto. Me esfuerzo por cumplir con las entregas en tiempo y forma, 
                gestionando cada tarea de manera eficiente. Además, la programación es mi pasión, por lo que desarrollo tanto proyectos personales como laborales.`,
    job: "Desarrollador Full Stack",
    span_english: "Inglés",
    span_spanish: "Español",
    portfolio: "Portafolio",
    phrases : [
        "La función de un buen software es hacer que lo complejo aparente ser simple”  - Grady Booch",
        "La perseverancia es muy importante. No debes rendirte a menos que te veas obligado a hacerlo”. - Elon Musk",
        ...
        "La mejor manera de predecir el futuro es implementarlo”. - David Heinemeier Hansson",
        "Primero hazlo funcionar, luego hazlo bien, después hazlo rápido.” - Kent Beck",
        "Son nuestras elecciones las que muestran lo que realmente somos, mucho más que nuestras habilidades” - J. K. Rowling",
      ]
}

/*export function AboutMe() {
    return <div dangerouslySetInnerHTML={{ __html: español.about }} />;
  }*/